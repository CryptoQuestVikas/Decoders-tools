import base64, codecs, hashlib, string, re, zipfile, threading, rarfile, jwt, binascii
...
def decode_base_n(data):
    ...
    for base in bases:
        try:
            ...
            continue
    return "[!] Could not decode using Base58/62/85."

def multilayer_decoder(data):
    try:
        # Try decoding Base64 > Hex > ROT13 in order
